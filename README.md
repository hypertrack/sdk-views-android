...
dependencies {
    implementation 'com.hypertrack:hypertrack-views:0.8.0'
    ...
}
```
...
```
In callback, that you pass as a second argument, you'll receive [MovementStatus](https://hypertrack.github.io/sdk-views-android/javadoc/0.8.0/com/hypertrack/sdk/views/dao/MovementStatus.html)
object that encapsulates various data describing device state.
Check out [docs](https://hypertrack.github.io/sdk-views-android/javadoc/0.8.0/) for data that is available.
...
into this method. Check out [documentation](https://hypertrack.github.io/sdk-views-android/javadoc/0.8.0/)
