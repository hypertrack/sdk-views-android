...
dependencies {
    implementation 'com.hypertrack:hypertrack-views:0.7.1'
    ...
}
```
...
```
In callback, that you pass as a second argument, you'll receive [MovementStatus](https://hypertrack.github.io/sdk-views-android/javadoc/0.7.1/com/hypertrack/sdk/views/dao/MovementStatus.html)
object that encapsulates various data describing device state.
Check out [docs](https://hypertrack.github.io/sdk-views-android/javadoc/0.7.1/) for data that is available.
...
into this method. Check out [documentation](https://hypertrack.github.io/sdk-views-android/javadoc/0.7.1/)
...
[reference](https://hypertrack.github.io/sdk-views-android/javadoc/0.7.1/constant-values.html#com.hypertrack.sdk.views.dao.MovementStatus.BATTERY_NORMAL)
